...
<head>
    ...
    <meta name="description" content="Yaskos - Personal scolar Website Template" />
    ...
    <title>Yaskos - Personal scolar Website Template</title>
  <!--favicon-img--> 
    ...
    <!--loader-end-->
        ...
        <div id="header">
            ...
            <div class="header-content">
                ...
                I'm a
            <span class="txt-rotate color" data-period="1200"data-rotate='[ " Designer.", " portfolioger.", " Freelancer." ]'></span>
    ...
    <!--copyright-section You Can Remove After Downloading-->
            <div class="footer">
             <div class="footer-text">
                 <img src="./images/copyright.png" alt="copyright-img" class="images" height="14px"> Yaskos
             </div>
            </div>
    <!--copyright-section-->
        </div>
        ...
        <div id="scolar">
            ...
            <div class="scolar-header"> <span class="color"> My </span> scolar
            <span class ="header-caption"> Some Of My <span class="color"> Works</span></span></div>
             <div id="scolar-content">
                 <div class="scolar scolar-first">
                     <div class="scolar-image">
                        <img src="images/scolar-first.jpg" alt="scolar-first">
                     </div>
                     <div class="scolar-text">
                         <h2>App Idea</h2>
                 ...
                 <div class="scolar scolar-second">
                    <div class="scolar-image">
                        <img src="images/scolar-second.jpg" alt="scolar-second">
                    </div>
                    <div class="scolar-text">
                        <h2>Web Designing</h2>
                ...
                <div class="scolar scolar-third">
                    <div class="scolar-image">
                        <img src="images/scolar-third.jpg" alt="scolar-third">
                    </div>
                    <div class="scolar-text">
                        <h2>UI Designing</h2>
                ...
                <div class="scolar scolar-fourth">
                    <div class=" scolar-image">
                        <img src="images/scolar-fourth.jpg" alt="scolar-fourth">
                    </div>
                    <div class="scolar-text">
                        <h2>Wow Graphics</h2>
                        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ad ut optio repellat cupiditate
       ...
       <!--copyright-section-->
        ...
        <div class="portfolio-header"> portfolios</span>
            <span class ="header-caption"> My Latest <span class="color"> portfolio posts.</span></span></div>
            <div class="portfolio-content">
                 <div class="portfolios">
                     <a href="#">
                     <div class="img">
                        <img src="images/post-one.jpg" alt="portfolio-one">
                        <div class="portfolio-date">8 May,20</div>
                     </div>
                 ...
                 <div class="portfolios">
                    <a href="#">
                    <div class="img">
                        <img src="images/post-two.jpg" alt="portfolio-two">
                        <div class="portfolio-date">16 Jan,20</div>
                    </div>
                    <div class="portfolio-text">
                ...
                <div class="portfolios">
                    <a href="#">
                    <div class="img">
                        <img src="images/post-three.jpg" alt="portfolio-three">
                        <div class="portfolio-date">30 Nov,19</div>
                    </div>
                    <div class="portfolio-text">
                ...
                <div class="portfolios">
                    <a href="#">
                    <div class="img">
                        <img src="images/post-four.jpg" alt="portfolio-four">
                        <div class="portfolio-date">6 Jul,19</div>
                    </div>
                    <div class="portfolio-text">
                ...
                <div class="portfolios">
                    <a href="#">
                    <div class="img">
                        <img src="images/post-five.jpg" alt="portfolio-five">
                        <div class="portfolio-date">1 Jun,19</div>
                    </div>
                    <div class="portfolio-text">
                ...
                <div class="portfolios">
                    <a href="#">
                    <div class="img">
                        <img src="images/post-six.jpg" alt="portfolio-six">
                        <div class="portfolio-date">28 Feb,19</div>
                    </div>
                    <div class="portfolio-text">
                        <h3>Business Trip</h3>
